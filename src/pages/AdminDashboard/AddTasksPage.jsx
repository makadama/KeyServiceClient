...
class AddTasksPage extends Component{
	constructor(props){
		super(props)
		this.state={
			libelle: '',
        		...
        		<div className="row">
        			<p className="text-center col-lg-12 col-md-12 col-xs-12">
                      ...
                      <form noValidate onSubmit={this.handleSubmit}>
                      	<h1 className="h3 mb-3 font-weight-normal">Ajouter une tâche</h1>
                      	  <div className="form-group">
                              <label htmlFor="fk_logement">Identifiant du bien*</label>
                              <input type="text" name="fk_logement"  id="fk_logement" placeholder="identifiant du bien" className={classnames("form-control",{
...
export default connect(mapStateToProps, {addTask})(AddTasksPage);