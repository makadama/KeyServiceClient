...
import { registerTraveler } from "../../actions/travelerActions";

class AddTravelerPage extends Component{
	constructor(props){
		super(props)
		this.state={
			email:'', 
	...
	onSubmit(e) {
		...
		this.props.registerTraveler(newUser);
	}
...
export default connect(mapStateToProps ,{registerTraveler}) (AddTravelerPage);
